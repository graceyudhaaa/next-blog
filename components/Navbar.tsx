  ...
  return (<header className="font-montserrat bg-white dark:bg-chambray-950 py-2 px-2 z-50 w-full sticky top-0 ">
    <div className="max-w-5xl mx-auto flex justify-between sm:items-center">
      ...
      <div className="flex gap-5 dark:text-cyan-50 items-center">
        <div className={clsx('flex flex-col divide-y divide-gray-200 dark:divide-chambray-800 sm:divide-y-0 sm:z-auto -z-10 dark:bg-chambray-950 bg-white sm:flex-row justify-center items-center sm:gap-3 absolute sm:static left-0 w-full transition-all duration-500', { 'top-12': open }, { 'top-[-500px]': !open })}>
          <Link href='/blog' className='inline-flex justify-center items-center w-full py-3 sm:py-0'>blog</Link>
          <Link href='/project' className='inline-flex justify-center items-center w-full py-3 sm:py-0'>project</Link>
          <Link href='/contact' className='inline-flex justify-center items-center w-full py-3 sm:py-0'>contact</Link>
        </div>
